...
func (in *ContourSpec) DeepCopyInto(out *ContourSpec) {
	*out = *in
	...
	if in.ContourSecurityContext != nil {
		in, out := &in.ContourSecurityContext, &out.ContourSecurityContext
		*out = new(v1.PodSecurityContext)
		(*in).DeepCopyInto(*out)
	}
	if in.EnvoySecurityContext != nil {
		in, out := &in.EnvoySecurityContext, &out.EnvoySecurityContext
		*out = new(v1.PodSecurityContext)
		(*in).DeepCopyInto(*out)
	}
}
