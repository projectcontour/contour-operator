...
func (in *ContourSpec) DeepCopyInto(out *ContourSpec) {
	*out = *in
	...
	out.EndpointPublishing = in.EndpointPublishing
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EndpointPublishing) DeepCopyInto(out *EndpointPublishing) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointPublishing.
func (in *EndpointPublishing) DeepCopy() *EndpointPublishing {
	if in == nil {
		return nil
	}
	out := new(EndpointPublishing)
	in.DeepCopyInto(out)
	return out
}
