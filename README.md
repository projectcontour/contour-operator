...
```
$ kubectl apply -f https://raw.githubusercontent.com/projectcontour/contour-operator/v1.18.1/examples/operator/operator.yaml
```
...
```
$ kubectl apply -f https://raw.githubusercontent.com/projectcontour/contour-operator/v1.18.1/examples/contour/contour.yaml
```
...
[Test with Ingress](https://projectcontour.io/docs/v1.18.1/deploy-options/#test-with-ingress):
```
...
[Code of Conduct](https://github.com/projectcontour/contour/blob/v1.18.1/CODE_OF_CONDUCT.md) before contributing.
